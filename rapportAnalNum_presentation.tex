...
L’étude des erreurs numériques et des temps d’exécution montre que l’efficacité d’une méthode dépend fortement du type de fonction traitée. Les résultats obtenus sont en accord avec les propriétés théoriques des méthodes étudiées.
